...
contract FundManager {
    ///@dev Array of supported currencies
    string[] private supportedCurrencies;

    ///@dev Maps supportedCurrencies to their indexes
    mapping(string => uint256) private currencyIndexes;

    ///@dev The supported currency codes to ERC20 token contract addresses.
    mapping(string => address) private currencyAddresses;

    ///@dev The supported currency codes to their decimal precisions.
