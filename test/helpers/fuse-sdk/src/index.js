...
const JumpRateModel = require("./irm/JumpRateModel.js");
const DAIInterestRateModelV2 = require("./irm/DAIInterestRateModelV2.js");
const WhitePaperInterestRateModel = require("./irm/WhitePaperInterestRateModel.js");
  ...
  constructor(web3Provider) {
    ...
    this.deployPool = async function (
      ...
      var poolAddress = this.getCreate2Address(
        Fuse.FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS,
        [options.from, poolName, await this.web3.eth.getBlockNumber() + 1],
